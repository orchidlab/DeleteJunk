...
public class Sacnning_Junk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sacnning__junk);
...
//                imageView.setImageDrawable(ContextCompat.getDrawable(Sacnning_Junk.this, R.drawable.green_circle));
                ...
                if (Build.VERSION.SDK_INT < 23) {
                    ...
                    scanning.setTextAppearance(getApplicationContext(), android.R.style.TextAppearance_DeviceDefault_Widget_ActionBar_Title);
                    ...
                    scanning.setTextAppearance(android.R.style.Theme_Material_Light_NoActionBar_Fullscreen);
                    scanning.setText(junk.getString("junk")+ " MB of Junk Files Are Cleared");
                    if (mInterstitialAd.isLoaded()) {
                        mInterstitialAd.show();
                    } else {
